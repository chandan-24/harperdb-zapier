...
module.exports = {
  operation: {
    ...
    inputFields: [
      ...
      },
      {
        ...
        type: 'string',
        helpText:
          'Column you want to search by with the value below. We will grab the latest matching row and give you all of its values',
  ...
  display: {
    label: 'Find a Row',
    description: 'Finds a row in the table via a lookup column',
    hidden: false,
    important: true,
  },
};
